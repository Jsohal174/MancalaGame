Make a mancala game with classes Board , MancalaGame , Pit , Player , Store.java and  also make a runner class for running these classes here are the rules of the mancala Mancala Rules
